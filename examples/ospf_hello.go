...
var OSPF = ospf.Packet{
	...
	Payload: ospf.Hello{
		...
		Options:                0x02,
		RtrPri:                 100,
		RouterDeadInterval:     160,
		DesignatedRouter:       net.IPv4(100, 1, 1, 254),
		BackupDesignatedRouter: net.IPv4(100, 1, 1, 253),
		Neighbors: []net.IP{
			net.IPv4(10, 1, 1, 2),
			net.IPv4(10, 1, 1, 3),
			net.IPv4(10, 1, 1, 4),
...
func main() {
	...
	iph := &ipv4.Header{
		...
		Len:      ipv4.HeaderLen,
		TOS:      0xc0, // DSCP CS6
		TotalLen: ipv4.HeaderLen + len(os),
		TTL:      1,
		Protocol: 89,
